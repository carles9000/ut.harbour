...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_DBTCDX, "../../../dbtcdx.prg", 0x0, 0x0003 )
...
HB_FUNC_INIT( DBTCDX_INIT )
{
	static const HB_BYTE pcode[] =
	{
		36,70,0,176,3,0,106,7,68,66,84,67,68,88,
		0,122,20,2,36,71,0,176,4,0,92,14,122,106,
		7,68,66,84,67,68,88,0,20,3,36,73,0,7
	};
