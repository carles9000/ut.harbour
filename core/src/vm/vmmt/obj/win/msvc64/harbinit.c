 ...
 * Generated C source from "../../../../harbinit.prg"
 */
...
{ "CLIPPER520", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( CLIPPER520 )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_HARBINIT, "../../../../harbinit.prg", 0x0, 0x0003 )
